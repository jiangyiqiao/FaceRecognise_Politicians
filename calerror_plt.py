...
count_rightpic=0
policy_names=['xijinping','makai','anghuning','liuyunshan','liuyandong','liuqibao','xuqiliang','sunchunlan',
'sunzhengcai','likeiqng','lijianguo','liyuanchao','wagyang','zhangchunxian','zhaogangli','zhangdejiang',
'fanchanglong','mengjianzhu','zhaoleji','huchuanhua','yuzhengsheng','lizhanshu','guojinglong',
'hanzheng','caiqi','guoshengkun','lihongzhong','yingyong','zedngqinghong','dengxiaoping','hujintao',
...
def main(args):
    ...
    for cls in dataset:
        for image_path in cls.image_paths:
            ...
            prediction_name=[prediction for prediction in predictions if prediction not in policy_names]
            if len(prediction_name):
...
def parse_arguments(argv):
    ...
    parser.add_argument('--input_dir', type=str, help='Directory with unaligned images.',default='./images/others/')
